namespace InfoSafe.API.Services
{
    public class UserService
    {
        ...
        public Guid UserId => Guid.Parse(_httpContextAccessor.HttpContext.User.Claims.FirstOrDefault(c => c.Type == "http://schemas.microsoft.com/identity/claims/objectidentifier").Value);
